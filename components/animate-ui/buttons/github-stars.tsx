...
function GitHubStarsButton({
  ...
  return (
    ...
    >
      ...
      <span>GitHub</span>
      <div className="relative inline-flex size-[18px] shrink-0 group">
        <Star
          className="stroke-muted-foreground fill-none transition-all duration-300 group-hover:stroke-white"
          size={18}
          aria-hidden="true"
        />
        <Star
          className="absolute top-0 left-0 text-white fill-white transition-all duration-300 group-hover:fill-white"
          aria-hidden="true"
          style={{
