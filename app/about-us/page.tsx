        ...
        <section className="flex flex-col items-center justify-center min-h-[50vh] px-4 py-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <a 
              ...
              className="bg-gray-800 hover:bg-gray-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg transition-all duration-300 text-center border border-gray-600 flex items-center justify-center gap-3 group"
            >
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 13.065l-11.99-7.065v14h23.98v-14zm11.99-8.065h-23.98l11.99 7.065z"/>
              </svg>
              Contact
              <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
